...
<section class="sessionCreate">
  ...
  <form id="sessionForm">
    ...
    <div class="field">
      ...
      <div class="control">
        <div class="select">
          <select id="trainingTitle" name="Formationr"></select>
        </div>
      </div>
    </div>
    <div class="field">
    ...
    <div class="field is-grouped">
      <div class="control">
        <button type="button" class="button is-link" id="submit">Créer la session</button>
      </div>
      <div class="control">
...
document.addEventListener("DOMContentLoaded", async function () {
  ...
  try {
    ...
    // Build a template using map and add the id and formation_name to each option
  ...
  if ($submit) {
    $submit.addEventListener('click', async function () {
      ...
      try {
        ...
        const formationCenter = document.getElementById("formationCenter");
        const selectedFormationOption = $trainingTitle.options[$trainingTitle.selectedIndex];
        const formationId = selectedFormationOption.id;
        const formationName = selectedFormationOption.value;
        ...
        const response = await fetch('https://cepegra-frontend.xyz/wf11-1/wp-json/wp/v2/session', {
          ...
          body: JSON.stringify({
            ...
            fields: {
              ...
              session_formation_name: formationName,
              session_formation_id: formationId,
            },
          }),
        });
            ...
            const evalResponse = await fetch('https://cepegra-frontend.xyz/wf11-1/wp-json/wp/v2/evals', {
              ...
              body: JSON.stringify({
                ...
                fields: {
                  ...
                  eval_formation_center: formationCenter,
